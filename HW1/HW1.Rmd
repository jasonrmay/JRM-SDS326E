...
Here I read in the data, dropped the missing data, and set a standard of data type for the two groups of variables. Notably, I included the year of make as qualitative variable since in this analysis it is treated as a label rather than a predictor. 
